        ...
        btnSendMessage.addEventListener('click', function () {
            ...
            if (messageText.length === 0) {
                ...
                setTimeout(function () {
                    ...
                    messageTextarea.setAttribute('placeholder', 'Escribe tu mensaje de felicitaciÃ³n...');
                }, 2000);
                return;
            }
            ...
            newMessage.innerHTML = `
                <div class="message-avatar" style="background: ${randomColor};">TÃº</div>
